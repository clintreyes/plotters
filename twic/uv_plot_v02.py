'''
    ...
    ver 02 - add if else that checks if angles are near 90 and 270 (from azimuth), plot should be switched to vertical
...
from stick_plot_v02 import stick_plot
...
#_ = plt.yticks(rotation = 70)

#ax.minor_ticks_on()
major_ticks = np.arange(-0.1, 0.15, 0.05)	#varying from dataset
#minor_ticks = np.arange(0, 2, 0.1)
ax.set_xticks(major_ticks)					#varying from ifelse
